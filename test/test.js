...
test('arrays', t => {
  ...
  const expected = fs.readFileSync('test/testdata/output/arrays.json', 'utf8');
...
test('french', t => {
  ...
  const expected = fs.readFileSync('test/testdata/output/french.json', 'utf8');
  const actual = JSON.canonicalize(input);
  t.is(actual, expected);
});
...
test('structures', t => {
  ...
  const expected = fs.readFileSync('test/testdata/output/structures.json', 'utf8');
  const actual = JSON.canonicalize(input);
  t.is(actual, expected);
});
...
test('values', t => {
  ...
  const expected = fs.readFileSync('test/testdata/output/values.json', 'utf8');
  const actual = JSON.canonicalize(input);
  t.is(actual, expected);
});
...
test('values', t => {
  ...
  const expected = fs.readFileSync('test/testdata/output/weird.json', 'utf8');
  const actual = JSON.canonicalize(input);
  t.is(actual, expected);
});
